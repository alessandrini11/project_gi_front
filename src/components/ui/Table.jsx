      ...
      <tbody className="text-gray-600 text-sm font-light">
          {list.map( (item, key) =>(
            <tr key={key} className="border-b border-gray-200 bg-gray-50 hover:bg-gray-100 text-sm">
              ...
              <td className="py-3 px-6 text-center">
                <div className="flex items-center justify-center">
                  <span className="">{item.moyenne}</span>
                </div>
              </td>
              <td className="py-3 px-6 text-center">
                <div className="flex item-center justify-center">
                  <a href="" className="w-4 mr-2 transform hover:text-purple-500 hover:scale-110"                                >
                  ...
                  <div className="">
                      <a href="" className="mr-2 transform hover:text-purple-500 hover:scale-110 ">
